...
<template>
  <div class="demo-box">
    ...
    <Field label="First name">
      <Text value="text2" placeholder="Type here" />
    </Field>
    <Field label="Last name">
      <Text v-model:value="text2" placeholder="Type here" />
    </Field>
    <Field label="Last name">
      <Text v-model:value="text2" disabled placeholder="Type here" />
    </Field>
  ...
  <div class="demo-box">
    ...
    <Field label="Password" position="left">
      <Text type="password" v-model:value="password2" />
    </Field>
  </div>
