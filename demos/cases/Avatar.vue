...
<template>
	<div class="demo-box">
		...
		<div class="single-avatars-row">
			<div class="single-avatar-item">
				<div class="single-avatar-slot">
...
.single-avatar-slot :deep(.wx-avatar-root) {
	width: 32px;
	height: 32px;
	max-width: 32px;
	max-height: 32px;
