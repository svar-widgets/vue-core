...
import FontOpenSans from "./FontOpenSans.vue";

defineOptions({ name: 'CoreWillowDark' });
const props = defineProps({
  fonts: { type: Boolean, default: true },
});

provide("wx-theme", "willow-dark");
</script>

<template>
	<div v-if="$slots.default" class="wx-theme wx-willow-dark-theme" style="height:100%">
		<slot></slot>
	</div>
